 ...
 * ES Module version - creates accounts, funds, donates XLM.
 */

import * as Stellar from "@stellar/stellar-sdk";
const { Keypair, Networks, SorobanRpc, TransactionBuilder, BASE_FEE, nativeToScVal, Address } = Stellar;
...
async function main() {
  ...
  // Markdown table
  console.log("📋 MARKDOWN TABLE (copy to FEEDBACK.md):\n");
  console.log("| # | Wallet (Testnet) | Name | Rating | Feedback Summary | Tx Hash | Explorer |");
  console.log("|---|---|---|---|---|---|---|");
  users.forEach(u => {
    const explorer = (u.txHash.startsWith("PENDING") || u.txHash.includes("FAIL")) ? "N/A" : `[View](https://stellar.expert/explorer/testnet/tx/${u.txHash})`;
